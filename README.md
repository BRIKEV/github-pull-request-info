...
Service to retrieve Github info from projects and store it in a postgres db
...
### Hierarchy
- __app__: github-pull-request-info root system (component).
...
```bash
{TIMESTAMP} | {LOG_LEVEL} [{github-pull-request-info}] | {MESSAGE}
```
